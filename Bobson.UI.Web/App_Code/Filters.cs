...
{/*
    public class AuthLogExcluirAttribute : AuthorizeAttribute
    {
        public AuthLogExcluirAttribute()
        {
        ...
        private void IsUserAuthorized(AuthorizationContext filterContext)
        {
            ...
            if (filterContext.HttpContext.User.Identity.IsAuthenticated)
            {
                ...
                //dict.Add("Message", "Me desculpe, você não está autorizado a executar esta operação.");

                //vr.ViewData = dict;
                vr.ViewBag.Message = "Me desculpe, você não está autorizado a executar esta operação.";
